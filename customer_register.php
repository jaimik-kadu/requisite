...
<main>
  ...
  <div class="nero">
    <div class="nero__heading">
      <span class="nero__bold">Register</span> AT REQUISITE
    </div>
    <p class="nero__text">
    </p>
  </div>
      ...
      <div class="box">
        ...
        <form action="customer_register.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="c_contact"  minlength="10" maxlength="10" required>
...
if (isset($_POST['register']))
{
  ...
  if ($result['success'] == 0)
  {
    ...
    $from = "jaimikkadu@gmail.com";

    $message = "

<h2>
Email Confirmation By requisite-store.com $c_name
</h2>
